...
//                logoImageUrl: "/srdlogo.png",
    ...
    <div class="parent-container">
        <div class="card">
            <div class="card-header">move and resize</div>



                <div class="card-body" id="jaas-container"></div>
            ...
            .draggable({
                ...
                listeners: {
                    move(event) {
                        ...
                        // Ensure the card stays within the parent container's bounds
            ...
            .resizable({
                ...
                listeners: {
                    move(event) {
                        ...
                        // Adjust position to maintain card within the parent bounds
